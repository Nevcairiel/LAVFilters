...
STDMETHODIMP CLAVSplitter::ReselectSubs(int streamId)
{
    ...
    if (subtitleStream)
    {
        Enable(subtitleStream->pid, AMSTREAMSELECTENABLE_ENABLE);
...
STDMETHODIMP CLAVSplitter::SetStreamSwitchReselectSubs(BOOL bEnabled)
{
...
STDMETHODIMP_(BOOL) CLAVSplitter::GetStreamSwitchReselectSubs()
{
